...
**КРИТИЧНО: Различай стремления и негативные сценарии.**
- **Стремления (что хотят):** q1 (идеальная жизнь), q2–q7, scenario_a/b/c, q8–q17, q18 (SUCCESS) — это цели, мечты, ограничения.
- **Негативные сценарии (чего НЕ хотят):** q19 (STAGNATION), q20 (FAILURE), q21 (что пугает) — описание провала/застоя. Там люди описывают, как будет плохо (например «живу в Твери, не добилась»). **Никогда не трактуй это как их желание.** Не говори «хочет жить в X», если X упомянуто только в негативном сценарии. Оценивай совместимость только по стремлениям.
  ...
  const res = await fetch(OPENROUTER_URL, {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: 'system',
          content: 'Ты аналитик совместимости видения со-основателей. Оценивай ТОЛЬКО по стремлениям (цели, желания, q1–q17, scenario_a/b/c, q18 SUCCESS). НЕ трактуй описание негативных сценариев (q19 STAGNATION, q20 FAILURE, q21) как желания — там люди описывают, чего боятся, а не чего хотят. Верни валидный JSON по схеме. Пиши на русском.',
        },
